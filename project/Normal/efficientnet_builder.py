""" EfficientNet Blocks and Builder
...
def get_act_layer(name='relu'):
    ...
    """
    return ACT_LAYER_DEFAULT[name]

def get_bn_args_tf():
    return BN_ARGS_TF.copy()
...
def resolve_se_args(kwargs, in_chs, act_layer=None):
    ...
    for k, v in SE_ARGS_DEFAULT.items():
...
def decode_arch_def(arch_def, depth_multiplier=2.2):
    arch_args = []
    for stack_idx, block_strings in enumerate(arch_def):
        ...
        arch_args.append(_scale_stage_depth(stack_args, repeats, depth_multiplier))
